            ...
            <div class="card-body remove-all-padding">
              ...
              @else
                @foreach ($param['orders'] as $order)
                  <div class="row remove-side-margin @if(Auth::user()->role == "Tiekėjas" && $order->supplier != null){{$order->supplier}}@endif">
                    ...
                    <div class="col-sm-1 col-2 text-center btn-functions" onclick="">
                       ...
                       <div class="functions-box">
                         <div class="btn-group-vertical">
                           ...
                           @elseif (Auth::user()->role == "Tiekėjas")
                             ...
                             <a href="{{route('order.color.green', ['id' => $order->id])}}" class="btn btn-light btn-orders-function text-success"><span class="fas fa-paint-brush"></span>&#160;Spalvinti</a>
                             <a href="{{route('order.color.yellow', ['id' => $order->id])}}" class="btn btn-light btn-orders-function text-warning"><span class="fas fa-paint-brush"></span>&#160;Spalvinti</a>
                             <a href="{{route('order.color.none', ['id' => $order->id])}}" class="btn btn-light btn-orders-function text-dark"><span class="fas fa-paint-brush"></span>&#160;Spalvinti</a>
                           @endif
                           <a href="#" class="btn btn-primary btn-orders-function" onclick="loadChatMessages('{{$order->id}}')"><span class="fas fa-question"></span>&#160;Chatas</a>
                        </div>
                       </div>
                    </div>
                  </div>
