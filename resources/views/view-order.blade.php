      ...
      <div class="col-md-10 col-12">
        <div class="card bg-dark text-light">
          <div class="card-header">
            ...
            @if($param['order']->type == "search" && Auth::user()->role == "Vadybininkas")
              ...
              <div class="col-6 text-right">
                @if($param['order']->status == "active")
                  <a href="{{route('order.edit', ['id' => $param['order']->id])}}" class="btn btn-outline-warning"><span class="far fa-edit"></span></a>
                @endif
              </div>
              </div>
            @elseif ($param['order']->type == "order" && Auth::user()->role == "Vadybininkas")
              <div class="row">
                <div class="col-6 justify-content-start">
                </div>
              <div class="col-6 text-right">
          ...
          <div class="card-body">
            ...
            @endif
            @if($param['order']->capacity != "" && $param['order']->capacity != "0")
              <div class="text-left">
                <b>Kubatūra: </b>{{$param['order']->capacity}} l
              </div>
            @endif
            @if($param['order']->fuel != "")
              <div class="text-left">
            ...
            @elseif(Auth::user()->role == "Vadybininkas" && $param['order']->status == "active")
                ...
                <div class="form-group row">
                  ...
                  <div class="col-9 text-left">
                       ...
                       <input name="image" type="file" id="image" class="form-control{{ $errors->has('image') ? ' is-invalid' : '' }}" accept="image/*" placeholder="Pridėti nuotrauką" required>
                       @if ($errors->has('image'))
            ...
            @endif
            @if($param['order']->price != null)
              <div class="text-left">
                <b>Kaina: </b>{{$param['order']->price}}&euro;
              </div>
            @endif
            ...
            <div class="justify-content-center" style="padding: 10px;">
                ...
                @elseif (Auth::user()->role == "Tiekėjas")
                  @if($param['order']->status == "active")<a href="{{route('order.found', ['id' => $param['order']->id])}}" class="btn btn-success btn-orders-function"><span class="far fa-check-circle"></span>&#160;Gavau</a>@endif
