        ...
        <div class="card bg-dark">
          ...
          <div class="card-body">
            <form method="POST" action="{{ route('search.add.submit') }}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <label for="carinfo" class="col-md-4 col-form-label text-md-right">Automobilio informacija</label>

                    <div class="col-md-6">
                        <textarea id="carinfo" class="form-control{{ $errors->has('carinfo') ? ' is-invalid' : '' }}" name="carinfo" value="{{ old('carinfo') }}" autocomplete="off" autofocus></textarea>
                        @if ($errors->has('carinfo'))
                            <span class="invalid-feedback">
                                <strong>{{ $errors->first('carinfo') }}</strong>
                            </span>
                        @endif
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6 text-left">
                         <input name="image" type="file" id="image" class="form-control{{ $errors->has('image') ? ' is-invalid' : '' }}" accept="image/*">
                         @if ($errors->has('image'))
                             <span class="invalid-feedback">
                ...
                <div class="form-group row mb-0 justify-content-center">
                        <button type="submit" class="btn btn-outline-light" id="order-search">
                            Išsaugoti
                        </button>
                </div>
            </form>
